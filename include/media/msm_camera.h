...
typedef enum {
CAMERA_BESTSHOT_OFF = 0,   // 0
CAMERA_BESTSHOT_AUTO = 1,
CAMERA_BESTSHOT_LANDSCAPE = 2,  //    1
CAMERA_BESTSHOT_SNOW,  // 2
CAMERA_BESTSHOT_BEACH, // 3
CAMERA_BESTSHOT_SUNSET, //4
CAMERA_BESTSHOT_NIGHT,  //5
CAMERA_BESTSHOT_PORTRAIT,       //6
CAMERA_BESTSHOT_BACKLIGHT,      //7
CAMERA_BESTSHOT_SPORTS, //8
CAMERA_BESTSHOT_ANTISHAKE,      //9
CAMERA_BESTSHOT_FLOWERS,        //10
CAMERA_BESTSHOT_CANDLELIGHT,    //11
CAMERA_BESTSHOT_FIREWORKS,      //12
CAMERA_BESTSHOT_PARTY,  //13
CAMERA_BESTSHOT_NIGHT_PORTRAIT, //14
CAMERA_BESTSHOT_THEATRE,        //15
CAMERA_BESTSHOT_ACTION, //16
CAMERA_BESTSHOT_AR,
CAMERA_BESTSHOT_MAX
